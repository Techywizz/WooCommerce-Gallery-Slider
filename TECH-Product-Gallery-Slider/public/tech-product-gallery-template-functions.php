 ...
 * @return string
 */
function tech_get_gallery_thumbnail( $attachment_id ) {
	$gallery_thumbnail = wc_get_image_size( 'gallery_thumbnail' );
	$thumbnail_size    = apply_filters( 'tech_gallery_thumbnail_size', array( $gallery_thumbnail['width'], $gallery_thumbnail['height'] ) );
	$full_size         = apply_filters( 'tech_gallery_full_size', apply_filters( 'tech_product_thumbnails_large_size', 'full' ) );
