 ...
 */
class TECH_Product_Gallery_Slider_Public {
    ...
    public function enqueue_styles() {
        if ( is_singular( 'product' ) ) {
            ...
            if ( 'yes' === get_option( 'tech_include_fa' ) ) { //only enqueue FA5 if admin option is checked
    ...
    public function load_template_functions() {
        require_once plugin_dir_path( __FILE__ ) . 'tech-product-gallery-template-functions.php';
    }
