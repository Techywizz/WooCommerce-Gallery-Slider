 ...
 */
class TECH_Product_Gallery_Slider_Reporter {
	...
	public function display_admin_notice() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/tech-product-gallery-slider-dependency-notice.php';
	}
}