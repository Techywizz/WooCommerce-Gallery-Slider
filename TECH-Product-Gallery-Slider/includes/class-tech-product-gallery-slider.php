...
class TECH_Product_Gallery_Slider {
	...
	/**
	 * The instance of the TECH_Product_Gallery_Slider_Dependencies Class
	 *
	 * @since    1.0.0
	 * @access   protected
	 * @var      obj    $dependency_check    instance of the TECH_Product_Gallery_Slider_Dependencies Class
	 */
	...
	public function __construct() {
		$this->plugin_name = __( 'WooCommerce Product Gallery Slider', 'techsolitaire' );
		$this->version = '1.0.0';
		$this->actions = array();
		$this->filters = array();
	}
	...
	public function run() {
		...
		} catch ( TECH_Product_Gallery_slider_Dependencies_Exception $e ) {
	...
	private function load_classes() {
		require_once plugin_dir_path( __FILE__ ) . 'custom-exceptions/class-tech-product-gallery-slider-dependencies-exception.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-tech-product-gallery-slider-dependencies.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-tech-product-gallery-slider-reporter.php';
	}
	...
	private function create_instances() {
		$this->dependency_check = new TECH_Product_Gallery_Slider_Dependencies();
	}
	...
	private function define_public_hooks() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-tech-product-gallery-slider-public.php';

		$plugin_public = new TECH_Product_Gallery_Slider_Public( $this->plugin_name, $this->version );
	...
	private function define_admin_hooks() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-tech-product-gallery-slider-admin.php';

		$plugin_admin = new TECH_Product_Gallery_Slider_Admin( $this->plugin_name, $this->version );
	...
	private function report_missing_dependencies( $missing_plugin_names ) {
		$missing_dependency_reporter = new TECH_Product_Gallery_Slider_Reporter( $missing_plugin_names, $this->plugin_name );
